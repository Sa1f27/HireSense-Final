...
export default function Home() {
  ...
  return (
    <main className="w-full">
      {/* Hero Section */}
      <div
        className="relative py-32 sm:py-48 lg:py-60 select-none bg-gradient-to-t from-pink-100 to-pink-200"
        id="waitlist-form"
      >
        ...
        <div className="relative text-center z-[1] mx-auto max-w-3xl lg:pb-16">
          ...
          <p className="mx-auto max-w-lg mt-5 text-lg/6 lg:text-xl/6 font-medium text-balance text-zinc-500">
            Instant checks across CVs, LinkedIn, GitHub, and calls to expose red
            flags and protect your hiring pipeline.
          </p>
          ...
          <div className="mt-10 max-w-lg mx-auto relative px-4 sm:px-0">
            ...
            <div className="lg:hidden absolute inset-0 pointer-events-none">
              ...
              <div
                className="absolute -top-4 right-4 w-1 h-1 bg-pink-400/30 rounded-full island-float-2"
                style={{ animationDelay: "1s" }}
              ></div>
              <div
                className="absolute top-2 right-2 w-2 h-2 bg-pink-200/50 rounded-full island-float-3"
                style={{ animationDelay: "2s" }}
              ></div>
              <div
                className="absolute -bottom-4 left-8 w-1.5 h-1.5 bg-pink-300/35 rounded-full island-float-1"
                style={{ animationDelay: "0.5s" }}
              ></div>
              <div
                className="absolute -bottom-2 left-2 w-1 h-1 bg-pink-400/40 rounded-full island-float-2"
