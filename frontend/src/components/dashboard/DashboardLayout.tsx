    ...
    >
      <div className="relative isolate flex min-h-svh w-full max-lg:flex-col">
                  ...
                  return (
                    <span key={item.name} className="relative">
                      ...
                      >
                        ...
                        <span className="z-[500] navbar_item whitespace-nowrap">
                          {item.name}
                        </span>
                      </button>
                    </span>
                ...
                if (hasSubItems && item.name === "Settings") {
                  return (
                    <div
                      key={item.name}
                      className={`${
                        shouldShowSettingsMenu ? "mb-1 bg-sidebar-active" : ""
                      }`}
                    >
                      <span className="relative">
                        ...
                        >
                          <Icon
                            className={`lucide z-[500] stroke-[2.1px] h-3 w-3 shrink-0 ${
                              active ? "stroke-stone-900" : "stroke-stone-500"
                            }`}
                          />
                          <span className="z-[500] navbar_item whitespace-nowrap flex-1">
                            {item.name}
                          </span>
                          <ChevronDown
                            className={`h-3 w-3 stroke-[2.1px] transition-transform ${
                              shouldShowSettingsMenu ? "rotate-180" : ""
                            }`}
                          />
                        </button>
                      </span>
                              ...
                              <span key={subItem.href} className="relative">
                                ...
                                <Link
                                  ...
                                  className={`flex w-full items-center gap-2 pl-6 pr-2 py-1 mb-1 text-left text-sm font-medium transition-colors ${
                                    subActive
                                      ? "text-stone-900 bg-sidebar-active"
                                      : "text-stone-500 hover:text-stone-900 hover:bg-sidebar-active active:bg-sidebar-active"
                                  }`}
                                >
                                  <SubIcon
                                    className={`z-[500] stroke-[2.1px] h-3 w-3 ${
                                      subActive
                                        ? "text-stone-900"
                                        : "text-stone-500"
                                    }`}
                                  />
                                  <span className="z-[500] navbar_item whitespace-nowrap text-sm">
                                    {subItem.name}
                                  </span>
                                </Link>
                              </span>
            ...
            <div className="p-4 border-b border-[#dbdac9]/50 flex items-center justify-between relative">
              ...
              <button
                ...
                className={`hidden lg:block p-1 text-stone-600 hover:text-stone-900 transition-colors ${
                  sidebarCollapsed
                    ? "absolute top-2 right-2 opacity-30 hover:opacity-60"
                    : ""
                }`}
                            ...
                            return (
                              <span key={subItem.href} className="relative">
                                ...
                                <Link
                                  ...
                                  title={
                                    sidebarCollapsed ? subItem.name : undefined
                                  }
                                >
                                  <SubIcon
                                    className={`z-[500] stroke-[2.1px] h-3 w-3 ${
        ...
        <div className="flex flex-1 flex-col w-full">
          ...
          {/* Main content */}
          <main
            className={`flex flex-1 flex-col lg:min-w-0 transition-all duration-300 ${
