    ...
    >
      ...
      <div className="mx-auto max-w-3xl text-center px-5 lg:px-0 relative">
        ...
        <div className="hidden lg:block absolute inset-0 pointer-events-none">
          ...
          <div
            className="absolute top-20 -right-48 island-float-1"
          ...
          {/* Middle left */}
          <div
            className="absolute top-8 -left-56 island-float-2"
          ...
          >
            ...
            <div className="flex items-center mt-1 ml-2">
              <div className="w-6 h-6 bg-pink-400 rounded-full flex items-center justify-center text-xs text-white font-medium">
                E
              </div>
          ...
          {/* Middle right */}
          <div
            className="absolute top-32 -right-52 island-float-3"
          ...
          >
            ...
            <div className="flex items-center justify-end mt-1 mr-2">
              ...
              <div className="w-6 h-6 bg-indigo-500 rounded-full flex items-center justify-center text-xs text-white font-medium">
                D
              </div>
            </div>
          </div>
      ...
      <div className="mt-20 mb-16 lg:mb-0 lg:border-y border-zinc-200">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2">
          {/* Left Testimonial */}
          <div className="p-8 lg:p-12 border-b lg:border-b-0 lg:border-r border-zinc-200">
            <p className="text-xl/8 text-zinc-800">
              &quot;HireSense is a game-changer. It&apos;s like having a
              superpower for recruitment. The insights are invaluable and have
              saved us from making costly hiring mistakes.&quot;
            </p>
            <p className="mt-6 font-semibold text-zinc-900">Sarah Johnson</p>
            <p className="text-sm text-zinc-600">Lead Recruiter, TechCorp</p>
          </div>
          {/* Right Testimonial */}
          <div className="p-8 lg:p-12">
            <p className="text-xl/8 text-zinc-800">
              &quot;I was skeptical at first, but after seeing the detailed
              analysis, I&apos;m a believer. HireSense helps us build trust with
              candidates and ensures we hire with confidence.&quot;
            </p>
            <p className="mt-6 font-semibold text-zinc-900">Michael Chen</p>
            <p className="text-sm text-zinc-600">
              Hiring Manager, Innovate Inc.
            </p>
          </div>
        </div>
      </div>
